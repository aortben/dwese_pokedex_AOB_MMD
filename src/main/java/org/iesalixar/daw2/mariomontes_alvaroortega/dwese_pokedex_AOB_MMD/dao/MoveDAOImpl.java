...
public class MoveDAOImpl implements MoveDAO {
    ...
    public void insertMove(Move move) {
        ...
        String sql = "INSERT INTO moves (name, type, category, power, accuracy, pp) VALUES (?, ?, ?, ?, ?, ?)";
    ...
    public void updateMove(Move move) {
        ...
        String sql = "UPDATE moves SET name = ?, type = ?, category = ?, power = ?, accuracy = ?, pp = ? WHERE id = ?";
    ...
    public boolean existsMoveByName(String name) {
        ...
        String sql = "SELECT COUNT(*) FROM moves WHERE UPPER(name) = ?";
    ...
    public boolean existsMoveByNameAndNotId(String name, Long id) {
        ...
        String sql = "SELECT COUNT(*) FROM moves WHERE UPPER(name) = ? AND id != ?";
